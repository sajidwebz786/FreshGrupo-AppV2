    ...
    try {
      ...
      try {
        ...
        if (verifyError.status === 401) {
          setErrorMessage(
            'Session expired. Payment may have succeeded. Please log in.',
          );
          setIsAuthed(false);
          return;
        }
      ...
      {isAuthed && (
        <>
          <ImageBackground
            ...
            resizeMode="cover"
            opacity={0.1}>
            <ScrollView style={styles.scrollContainer} scrollEnabled={!loading}>
              {/* Package Details */}
              {creditPackage && (
                  ...
                  <View style={styles.packageDetails}>
                    ...
                    <View style={[styles.detailRow, styles.highlightRow]}>
                      ...
                      <Text style={styles.priceValue}>
                        ₹{parseFloat(creditPackage.price).toFixed(2)}
                      </Text>
                    </View>
                    ...
                    <View style={styles.detailRow}>
                      ...
                      <Text style={styles.detailValue}>
                        ₹
                        {(
                          parseFloat(creditPackage.price) /
                          (creditPackage.credits + creditPackage.bonusCredits)
                        ).toFixed(2)}
                      </Text>
                    </View>
              ...
              <View style={styles.termsContainer}>
                <Text style={styles.termsText}>
                  ...
                  Policy. Credits purchased are non-refundable.
                </Text>
              </View>
              ...
              <TouchableOpacity
                ...
                {loading ? (
                  ...
                  <Text style={styles.purchaseButtonText}>
                    {creditPackage
                      ? `Pay ₹${parseFloat(creditPackage.price).toFixed(
                          2,
                        )} & Get Credits`
                      : customAmount
